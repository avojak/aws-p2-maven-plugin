...
//	@Before
//	public void setup() {
//		landingPageGenerator = new HtmlLandingPageWriter(escaper);
...
//		new HtmlLandingPageWriter(null);
//	}
//
//	/**
//	 * Tests that {@link HtmlLandingPageWriter#write(String, String, Date)} throws an exception when the given bucket
//	 * name is {@code null}.
//	 *
...
//		landingPageGenerator.write(null, projectName, date);
//	}
//
//	/**
//	 * Tests that {@link HtmlLandingPageWriter#write(String, String, Date)} throws an exception when the given bucket
...
//		landingPageGenerator.write(" ", projectName, date);
//	}
//
//	/**
//	 * Tests that {@link HtmlLandingPageWriter#write(String, String, Date)} throws an exception when the given project
//	 * name is {@code null}.
//	 *
//	 * @throws IOException unexpected.
//	 */
...
//		landingPageGenerator.write(bucketName, null, date);
//	}
//
//	/**
//	 * Tests that {@link HtmlLandingPageWriter#write(String, String, Date)} throws an exception when the given project
...
//		landingPageGenerator.write(bucketName, " ", date);
//	}
//
//	/**
//	 * Tests that {@link HtmlLandingPageWriter#write(String, String, Date)} throws an exception when the given date is
//	 * {@code null}.
//	 *
//	 * @throws IOException unexpected.
//	 */
...
//		landingPageGenerator.write(bucketName, projectName, null);
//	}
//
//	/**
//	 * Tests {@link HtmlLandingPageWriter#write(String, String, Date)}
//	 *
//	 * @throws IOException unexpected.
//	 */
//	@Test
...
//		File file = null;
//		try {
//			file = landingPageGenerator.write(bucketName, projectName, date);
